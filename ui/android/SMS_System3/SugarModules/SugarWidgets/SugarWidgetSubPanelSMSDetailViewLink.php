...
class SugarWidgetSubPanelSMSDetailViewLink extends SugarWidgetField
{
	function displayList(&$layout_def)
	{
		...
		if(  !empty($record) &&
			...
			|| ACLController::checkAccess($layout_def['owner_module'], 'view', $layout_def['owner_id'] == $current_user->id))){
				 ...
				 if($layout_def['fields']['DETAILCAMPAIGNVIEW'] == 'campaigns') {
					 if($layout_def['fields']['STATUS'] == 'Sent')
					 	return '<a onClick="return openDialogCampaignWindow(this, \'Sent\');" href="index.php?module='.$module.'&action='.$action.'&record='.$record.$parent.'" class="listViewTdLinkS1">'."$value</a>";
					else 
						return '<a onClick="return openDialogCampaignWindow(this,\'NotSent\');" href="index.php?module='.$module.'&action='.$action.'&record='.$record.$parent.'" class="listViewTdLinkS1">'."$value</a>";
				 	
				 } else {
					 if($layout_def['fields']['STATUS'] == 'Sent')
					 	return '<a onClick="return openDialogWindow(this, \'Sent\');" href="index.php?module='.$module.'&action='.$action.'&record='.$record.$parent.'" class="listViewTdLinkS1">'."$value</a>";
					else 
						return '<a onClick="return openDialogWindow(this,\'NotSent\');" href="index.php?module='.$module.'&action='.$action.'&record='.$record.$parent.'" class="listViewTdLinkS1">'."$value</a>";
				 }
