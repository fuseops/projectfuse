...
if(isset($sugar_config["smsEnabled"])) {
	if($sugar_config["smsEnabled"] == true) {
		$xtpl->assign('smsClientUrl', $sugar_config["smsClientUrl"]);
		$xtpl->assign('SMSAPIKEY', $focus->getPreference('SMSAPIKEY' ));
		$smsapipassword = (strlen($focus->getPreference('SMSAPIPASSWORD')) > 0 ? "XXXXX" : "");
		$xtpl->assign('SMSAPIPASSWORD', "$smsapipassword");
		$xtpl->parse('sms_info');
	}
}
