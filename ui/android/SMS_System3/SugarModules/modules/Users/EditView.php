...
if(isset($sugar_config["smsEnabled"])) {
	if($sugar_config["smsEnabled"] == true) {
		$sugar_smarty->assign('smsClientUrl', $sugar_config["smsClientUrl"]);
		$sugar_smarty->assign('SMSAPIKEY', $focus->getPreference('SMSAPIKEY' ));
		$sugar_smarty->assign('SMSAPIPASSWORD', $focus->getPreference('SMSAPIPASSWORD' ));		
	}
}
