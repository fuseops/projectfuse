...
<script type='text/javascript' src='modules/Users/sms.js'></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="edit view">
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<th  align="left" scope="row" colspan="4"><h4>{$APP.LBL_SMS_SETTINGS}</h4></th>
				</tr>
				
				<tr>
					<td scope="row" width="17%">{$APP.LBL_SMS_SERVICE_BY}</td>
					<td scope="row" width="17%" nowrap ><a href='http://www.intdevsms.com' target='_new'><IMG src='custom/themes/default/images/smslogo.jpg' border='0'  alt='SMS'></a></td>
					<td scope="row" width="66%" colspan="2"></td>
				</tr>
				<tr>
					<td scope="row" width="17%" colspan="4">{$APP.LBL_SMS_MESSAGE}</td>
				</tr>				
				
				<tr>
					<td scope="row" width="17%">{$APP.LBL_SMSURL}</td>
					<td scope="row" width="17%" colspan="2">{$smsClientUrl}</td>
					<td scope="row" width="17%"></td>
				</tr>
				<tr>
					<td scope="row" width="17%">{$APP.LBL_SMSAPIKEY}</td>
					<td scope="row" width="17%"><input type="text" name="SMSAPIKEY" id="SMSAPIKEY" value="{$SMSAPIKEY}"  size='25' maxlength='25' tabindex="5"><br><span id="SMSAPIKEYError" class="required"></span></td>
					<td scope="row" width="17%" colspan="2"></td>
				</tr>
				<tr>
					<td scope="row" width="17%">{$APP.LBL_SMSAPIPASSWORD}</td>
					<td scope="row" width="17%"><input type="password" name="SMSAPIPASSWORD" id="SMSAPIPASSWORD" value="{$SMSAPIPASSWORD}"  size='25' maxlength='25'  tabindex="5"><br><span id="SMSAPIPASSWORDError" class="required"></span></td>
					<td scope="row" width="17%" colspan="2"></td>
				</tr>
				<tr>
					<td scope="row" width="17%">&nbsp;</td>
					<td scope="row" width="17%" colspan="2"><input class="button" type="button" value="Test Login" name="testsettings" id="testsettings" onclick="return getQueryBalanceCheckSettings();"  title="Test Settings"/>&nbsp;&nbsp;<span id="qryBalanceSpan" class="required"></span></td>
					<td scope="row" width="17%"></td>					
				</tr>
			</table>
		</td>
